...
def main():
    ...
    for ep in range(config.train_setting.epoch):
        ...
        if True:
            ...
            LOGGER.info(str("Validation Loss in Epoch " + str(ep) + " : " + str(lossAverageMeterTrain.avg)))
            LOGGER.info(str("Validation heatmapPredictionErrorAverageMeter in Epoch " + str(ep) + " : " + str(heatmapPredictionErrorAverageMeterTrain.avg)))
            LOGGER.info(str("Validation PosePredictionCosineSimilarityPerJointErrorAverageMeter in Epoch " + str(ep) + " : " + str(PosePredictionCosineSimilarityPerJointErrorAverageMeterTrain.avg)))
            LOGGER.info(str("Validation PosePredictionDistancePerJointErrorAverageMeter in Epoch " + str(ep) + " : " + str(PosePredictionDistancePerJointErrorAverageMeterTrain.avg)))
            LOGGER.info(str("Validation PosePredictionMSEErrorAverageMeter in Epoch " + str(ep) + " : " + str(PosePredictionMSEErrorAverageMeterTrain.avg)))
            LOGGER.info(str("Validation heatmapReconstructionErrorAverageMeter in Epoch " + str(ep) + " : " + str(heatmapReconstructionErrorAverageMeterTrain.avg)))
            LOGGER.info(str("Validation fullBodyErrorAverageMeter in Epoch " + str(ep) + " : " + str(eval_body_train.get_results()["All"])))
            LOGGER.info(str("Validation upperBodyErrorAverageMeter in Epoch " + str(ep) + " : " + str(eval_body_train.get_results()["UpperBody"])))
            LOGGER.info(str("Validation lowerBodyErrorAverageMeter in Epoch " + str(ep) + " : " + str(eval_body_train.get_results()["LowerBody"])))
            ...
            io.write_json(os.path.join(os.getcwd(), config.eval.experiment_folder, str("epoch_" + str(ep)), config.eval.training_result_file), res_train)
            ...
            copyfile("data/config.yml", os.path.join(os.getcwd(), config.eval.experiment_folder, str("epoch_" + str(ep)), config.eval.experiment_configuration_file))
