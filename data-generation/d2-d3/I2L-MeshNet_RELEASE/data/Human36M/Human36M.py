...
class Human36M(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            # print(inputs['img'].shape) # torch.Size([3, 256, 256])
            # print(targets['orig_joint_img'].shape) # (29, 3)
            # print(targets['fit_joint_img'].shape) # (29, 3)
            # print(targets['fit_mesh_img'].shape) # (6890, 3)
            # print(targets['orig_joint_cam'].shape) # (29, 3)
            # print(targets['fit_joint_img'].shape) # (29, 3)
            # print(targets['pose_param'].shape) # (72,)
            # print(targets['shape_param'].shape) # (10,)
            # print(meta_info['orig_joint_valid'].shape) # (29, 1)
            # print(meta_info['orig_joint_trunc'].shape) # (29, 1)
            # print(meta_info['fit_joint_trunc'].shape) # (29, 1)
            # print(meta_info['fit_mesh_trunc'].shape) # (6890, 1)
            # print(meta_info['is_valid_fit'].shape) # float
            # print(meta_info['is_3D'].shape) # float
