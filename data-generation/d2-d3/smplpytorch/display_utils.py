...
def save_obj(v, f, file_name='output.obj'):
    ...
    for i in range(len(v)):
        obj_file.write('v ' + str(v[i][0].item()) + ' ' + str(v[i][1].item()) + ' ' + str(v[i][2].item()) + '\n')
    for i in range(len(f)):
        obj_file.write('f ' + str(f[i][0].item()+1) + '/' + str(f[i][0].item()+1) + ' ' + str(f[i][1].item()+1) + '/' + str(f[i][1].item()+1) + ' ' + str(f[i][2].item()+1) + '/' + str(f[i][2].item()+1) + '\n')
    obj_file.close()